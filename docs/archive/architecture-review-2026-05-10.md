...
> Archived 2026-07-26. This point-in-time review mixed durable architecture,
> completed work, and an engineering action list. Use
> `docs/architecture-review.md` for the consolidated current reference.
