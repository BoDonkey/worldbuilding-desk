> **Archived 2026-08-01.** Superseded by the consolidated `docs/product-blueprint.md` (2026-08-01), which merges this with navigation IA, style bible, multi-mode directives, and a11y guardrails.
