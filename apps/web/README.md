...
- [@vitejs/plugin-react](https://github.com/vitejs/vite-plugin-react/blob/main/packages/plugin-react) uses [Oxc](https://oxc.rs/) for Fast Refresh with Vite 8; Babel transforms require the separate [`@rolldown/plugin-babel`](https://github.com/rolldown/plugins/tree/master/packages/babel) plugin
